...
if __name__ == '__main__':
    ...
    for i in range(0,8):
        ...
        if hero_index=="0":
            ...
            script_file.write("python entry.py --actor_id={} --eval_number=20 --agent_models=\"{},{}\"\n".format(i,diaochan_model_dir,luban_model_dir))
        if hero_index=="1":
            script_file.write("python entry.py --actor_id={} --eval_number=20 --agent_models=\"{},{}\"\n".format(i,diaochan_model_dir,miyue_model_dir))
        if hero_index=="2":
            script_file.write("python entry.py --actor_id={} --eval_number=20 --agent_models=\"{},{}\"\n".format(i,diaochan_model_dir,lvbu_model_dir))
        if hero_index=="3":
            script_file.write("python entry.py --actor_id={} --eval_number=20 --agent_models=\"{},{}\"\n".format(i,diaochan_model_dir,libai_model_dir))
        if hero_index=="4":
            script_file.write("python entry.py --actor_id={} --eval_number=20 --agent_models=\"{},{}\"\n".format(i,diaochan_model_dir,diaochan_model_dir))
