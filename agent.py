...
class Agent:
    ...
    def reset(self, agent_type=None, model_path=None):
        ...
        if Config.SINGLE_TEST:
            ...
            # self._predictor._tf_load_api("/root/save/checkpoints_20210603_165755.029224.tar")
        else:
            if model_path is None:
                ...
                if model_path != self.last_model_path:
                    ...
                    LOG.info("model {} alreadly load last time, skip now!".format(model_path))
    ...
    def _sample_masked_action(self, logits, legal_action):
        ...
        target_legal_action_o = np.reshape(legal_actions[index], # [12, 8]
