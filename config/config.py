...
class ModelConfig:
    ...
    IS_REINFORCE_TASK_LIST = [True, True, True, True, True, True] # means each task whether need reinforce
...
class Config:
    ...
    #kinghonour_dqn
    ALGORITHM = "kinghonour_dqn"
    DATA_SHAPES = [[5888]]
    DATA_SPLIT_SHAPE = [2823, 79, 2823, 79, 1, 1, 1, 1, 79, 1]
    INPUT_DIM = [2823]
if __name__ == '__main__':
    print(np.sum([[12944], [16], [16], [16], [16], [16], [16], [16], [16], [192], [256], [256], [256], [256], [128], [16], [16], [16], [16], [16], [16], [16]]))