...
from sail.mem_pool import MemPoolAPIs
...
class SampleManager():
    def __init__(self, mem_pool_addr, mem_pool_type, num_agents, game_id=None, local_mode=False):
        # connect to mem pool
        ...
        if Config.SINGLE_TEST or local_mode:
            ...
            self._mem_pool_api = MemPoolAPIs(self.m_mem_pool_ip, self.m_mem_pool_port, socket_type=mem_pool_type)
    ...
    def _calc_reward(self):
        ...
        for i in range(self.num_agents):
            ...
            for j in reversed_keys:
                ...
                # if np.isnan(rl_info.reward_sum ):
                #     print("reward nan")
                #     exit(0)
                # if rl_info.reward_sum>100 or rl_info.reward_sum<-100:
                #     print("reward too big",rl_info.reward_sum)
    ...
    # _data_shapes = [[9200], [16], [16], [16], [16], [16], [16], [16], [16], [192], [256], [256], [256], [256], [128],
    #                [16], [16], [16], [16], [16], [16], [16], [512], [512]]
    # _LSTM_FRAME = 16
